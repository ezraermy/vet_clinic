...
**[vet_clinic]** is a relational database to create the initial data structure for a vet clinic. I created a table to store animals' information, insert some data into it, and query it.
...
- **[Develop more fields for vet_clinic]**
...
- Code editor like VScode, atom, etc.
...
```bash
git clone https://github.com/ezraermy/vet_clinic.git
```
```bash
cd vet_clinic
```
...
Feel free to check the [issues page](https://github.com/ezraermy/vet_clinic/issues).
